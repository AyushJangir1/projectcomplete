        ...
        <div style={{ backgroundColor: "#99cc99" }}>
          <div>
            <marquee behavior="scroll" direction="left" scrollamount="4,0">
              ...
              >
                <strong>
                  The respective informations and updates on the Hostel
                  Allotment Dates and the respective rank lists will be
                  displayed on the dashboard of the applicable students. In
                  addition to that, the fee withdrawal procedures are neglected
                  for now !!!!!
                </strong>
              </span>
            </marquee>
          ...
          <Col>
            ...
            <div className="AccountList">
              ...
              >
                ...
                <Input
                  type="select"
                  value={this.state.userMartialStatus}
                  size="sm"
                  style={{ width: "200px" }}
                >
                  <option>--select--</option>
