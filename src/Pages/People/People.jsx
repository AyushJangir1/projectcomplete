...
function People() {
    return (
      ...
      <div style={{ display: 'flex', gap: '7%', marginTop: '2px', backgroundColor: '#2196F3', height: '40px', justifyContent: 'center', alignItems: 'center', overflow: 'auto' }}>
        ...
        <a href="https://www.mbmalumni.org/" target="_blank">
          <div className='topLink'>
            COMMITTEE
          </div>
        </a>
        <a href='https://www.mbm.ac.in/ug-pg-admissions' target="_blank">
          <div className='topLink'>
            News
          </div>
        </a>
        <a href="https://www.mbm.ac.in/" target="_blank">
          <div className='topLink'>
            ABOUT US
          </div>
        </a>
        <a href="https://www.mbm.ac.in/reach-mbm" target="_blank">
          <div className='topLink'>
            CONTACT
          </div>
        </a>
